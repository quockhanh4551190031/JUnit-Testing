...
public class QuadrilateralTest {
	...
	/*
	 * @Test public void testRectangle() { String msg = "Should be a rectangle";
	 * assertTrue(msg, square1.isRectangle()); assertTrue(msg,
	 * square2.isRectangle()); assertTrue(msg, rectangle1.isRectangle());
	...
	public void testRectangle() {
		...
		assertTrue(msg, square1.isSquare());
		assertTrue(msg, square2.isSquare());
